...
function ProfileContent(): ReactElement {
  ...
  const handleAvatarUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      toast({
        title: "Info",
        description: "Gambar dipilih. Klik 'Update Profile' untuk menyimpan.",
      })
    }
  }
  ...
  const handleEmailVerification = () =>
    toast({ title: "Info", description: "Mengirim ulang email verifikasi..." })

  const handleNotificationSave = () =>
    toast({ title: "Sukses", description: "Preferensi notifikasi disimpan." })
