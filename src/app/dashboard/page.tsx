...
// Komponen ini berisi tampilan UI asli dari dashboard Anda
function DashboardContent() {
    // Mengambil data pengguna dari AuthContext
    const { user } = useAuth(); 

    // State untuk data booking (masih menggunakan data statis untuk contoh)
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="mb-8">
                    {/* Menggunakan nama pengguna dari context */}
...
// Komponen utama yang diekspor, kini berfungsi sebagai "pembungkus"
// yang menerapkan perlindungan rute.
